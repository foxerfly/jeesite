...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../../static/css/views/modules/sysLogin.css"/>
...
<div class="header"><%
    ...
    <div id="messageBox" class="alert alert-error <%=error==null?"hide":""%>">
        ...
        <label id="loginError"
               class="error"><%=error == null ? "" : "com.thinkgem.jeesite.modules.sys.security.CaptchaException".equals(
                error) ? "验证码错误, 请重试." : "用户名或密码错误, 请重试." %>
        </label>
    </div>
</div>
